      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full btn bg-[#22c55e] px-8 py-4 text-[18px] text-white font-black shadow-md hover:bg-[#16a34a] transition-all disabled:opacity-50 mt-4 rounded-2xl"
          >
